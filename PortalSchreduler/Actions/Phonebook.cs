...
namespace PortalSchreduler.Actions
{
	public static class Phonebook
    {
        public static async Task Load()
        {
            ...
            for (int k = 1; k < 5; k++)
            {
                string raw = await HtmlLoader.LoadAsync("http://phone.vitebsk.energo.net/users?page=" + k + "&size=50&org=%D0%92%D0%B8%D1%82%D0%B5%D0%B1%D1%81%D0%BA%D0%B0%D1%8F%20%D0%A2%D0%AD%D0%A6");
